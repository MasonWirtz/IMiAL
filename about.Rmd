...
*In this talk I introduce a selection of approaches that I have taken to the analysis of masculinities in my work on the self-recorded, spontaneous talk of a group of young men from ethnically and racially mixed working-class backgrounds in southeast London.*

*I will introduce an interactional sociolinguistic approach, informed by Bakhtin’s (1981; 1984; 1986) work on dialogicality and Tannen’s (1989; 2004) notion of constructed dialogue, which has allowed me to explore the young men’s use of voices in relation to a range of discourses which are shaped by and shape their intersectional masculinities. Intersections of race, ethnicity and social class inform many of the young men’s positions, for example when they talk about their own ‘overstanding’ of hip hop in relation to the mere ‘understanding’ of ‘white kids from Oxford’, or when they contrast their own experience of southeast London with that of ‘Hipsters moving into the hood’. Another example is their discussion of social inequality in the context of the ‘2011 London Riots’, where they consider their own position in relation to rioters who resorted to ‘stealing rice from a shop’ on one hand, and ‘people who don’t need shit […] they go skiing in the Alps at Christmas’ on the other.*

*I will argue that for the analysis of the indexical processes at the centre of the young men’s positioning we need to consider the ‘microcontext of interaction’ in relation to the ‘macrosociological order’ (Silverstein 2004: 638-639). Silverstein’s term ‘cultural concepts’ is useful in this endeavour, as it allows us to consider how speakers draw on words and expressions which index certain cultural knowledge and constitute important resources for their positioning.  My presentation highlights the importance of approaching the analysis of these indexical processes from an intersectional approach and aims to provide insight into how ‘subjects mobilise (or choose not to mobilise) particular aspects of their identities in particular circumstances’ (Nash 2008: 11).*

*References:* 

Bakhtin, Mikhail (1981) *The dialogic imagination* (trans. Caryl Emerson and Michael Holquist). Austin, TX: University of Texas Press.

Bakhtin, Mikhail (1984) *Problems of Dostoevsky’s poetics.* Ed. and transl. Caryl Emerson. Minneapolis: University of Minnesota Press.  

Bakhtin, Mikhail (1986) The problem of speech genres. In *Speech genres & other late essays*, ed. Caryl Emerson and Michael (transl by Vern McGee), pp 60-102. Austin: University of Texas Press 
...
Tannen, Deborah (2004) Talking the dog: farming pets and interactional resources in family discourse. *Research on Language and Social Interaction* 37(4): 399-420. 
...
**Quantitative Perspektiven zur dialektalen (Morpho-)Syntax in Österreich: Soziale und areale Faktoren**
...
JProf. Dr. Andreas Weilinghoff is a junior professor in English linguistics at the University of Koblenz, the youngest university in Germany. He has a passion for speech and speech technology as well as for data processing and analysis.
