...
Navigate this interactive schedule to find information on the `lecturer`, `date`, `University of employment`, `topic`, `title`, and `room number`. 
...
schedule = tibble(
  ...
  "Room Number" = c("Unipark, 4.102", 
                    "Unipark, 4.102", 
                    "Unipark, 4.102"),
  University = c("University of Postdam", 
